...
original_data = ad.read_h5ad("/workspace/deepimpute/data/citeseq_preprocessed.h5ad")
...
mask[SITE1_CELL + SITE2_CELL: SITE1_CELL + SITE2_CELL + SITE3_CELL, :2000] = True
nonzero_mask31 = (ground_truth[SITE1_CELL + SITE2_CELL: SITE1_CELL + SITE2_CELL + SITE3_CELL, :2000] != 0)
...
expression_data = pd.read_csv('/workspace/deepimpute/data/citeseq_imputed.csv', index_col=0)
...
### pearson
pearson_corr = pearsonr(X_imputed[SITE1_CELL + SITE2_CELL: SITE1_CELL + SITE2_CELL + SITE3_CELL, :2000][nonzero_mask31], ground_truth[SITE1_CELL + SITE2_CELL: SITE1_CELL + SITE2_CELL + SITE3_CELL, :2000][nonzero_mask31])[0]
### mae & rmse
mae, rmse = calculate_mae_rmse(X_imputed[SITE1_CELL + SITE2_CELL: SITE1_CELL + SITE2_CELL + SITE3_CELL, :2000], ground_truth[SITE1_CELL + SITE2_CELL: SITE1_CELL + SITE2_CELL + SITE3_CELL, :2000], nonzero_mask31)
