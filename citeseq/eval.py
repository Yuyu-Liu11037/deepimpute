...
assert expression_data.shape[0] == cell_metadata.shape[0], "Mismatch in the number of cells."
adata = ad.AnnData(X=expression_data.values, 
                   obs=cell_metadata, 
                   var=gene_metadata)
X_imputed = adata.X
print(X_imputed.shape)
print(X_imputed[SITE1_CELL + SITE2_CELL: SITE1_CELL + SITE2_CELL + SITE3_CELL, :13953])
print(X_imputed[SITE1_CELL + SITE2_CELL: SITE1_CELL + SITE2_CELL + SITE3_CELL, :13953][nonzero_mask31])
...
### cmd
cmd = correlation_matrix_distance(correlation_matrix(X_imputed[SITE1_CELL + SITE2_CELL: SITE1_CELL + SITE2_CELL + SITE3_CELL, :13953]), correlation_matrix(ground_truth[SITE1_CELL + SITE2_CELL: SITE1_CELL + SITE2_CELL + SITE3_CELL, :13953]))
